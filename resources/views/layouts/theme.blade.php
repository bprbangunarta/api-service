...
<div class="settings">
    <a href="#" class="btn btn-floating btn-icon btn-primary" data-bs-toggle="offcanvas" data-bs-target="#offcanvasSettings">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-brush">
    ...
    <form class="offcanvas offcanvas-start offcanvas-narrow" tabindex="-1" id="offcanvasSettings">
        <div class="offcanvas-header">
            <h2 class="offcanvas-title">Sesuaikan Tema</h2>
        ...
        <div class="offcanvas-body d-flex flex-column">
            <div>
                ...
                <div class="mb-4">
                    ...
                    <p class="form-hint">Pilih mode warna untuk aplikasi Anda.</p>
                ...
                <div class="mb-4">
                    ...
                    <p class="form-hint">Pilih jenis font yang sesuai dengan aplikasi Anda.</p>
                    <div>
                        <label class="form-check">
                            <div class="form-selectgroup-item">
                ...
                <!-- Basis tema -->
                <div class="mb-4">
                    <label class="form-label">Basis tema</label>
                    <p class="form-hint">Pilih warna abu-abu untuk aplikasi Anda.</p>
                    <div>
                        <label class="form-check">
                            <div class="form-selectgroup-item">
