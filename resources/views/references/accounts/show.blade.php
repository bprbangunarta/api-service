    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('ref-account.index') }}" class="btn btn-2 btn-5 d-none d-sm-inline-block">
                    ...
                    <a href="{{ route('ref-account.index') }}" class="btn btn-2 btn-6 d-sm-none btn-icon">
                            ...
                            <div class="row g-2">
                                <div class="col-xl-4 col-md-4 col-sm-12">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" name="code" id="code" value="{{ $data['account']->code }}" />
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-12">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" name="code" id="name" value="{{ $data['account']->name }}" />
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-12">
                                    <div class="mb-2">
                                        <label class="form-label mb-0">Balance</label>
                                        <input type="text" class="form-control" name="balance" id="balance" value="{{ $data['account']->balance }}" disabled />
