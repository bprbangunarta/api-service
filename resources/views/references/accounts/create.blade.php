                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-12">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" name="code" id="name" value="{{ old('name') }}" />
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-12">
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" name="balance" id="balance" value="{{ old('balance') }}" disabled />
